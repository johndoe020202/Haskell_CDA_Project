...
/* package Haskell-CDA-Project-0.1.0.0 */
#ifndef VERSION_Haskell_CDA_Project
#define VERSION_Haskell_CDA_Project "0.1.0.0"
#endif /* VERSION_Haskell_CDA_Project */
#ifndef MIN_VERSION_Haskell_CDA_Project
#define MIN_VERSION_Haskell_CDA_Project(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Haskell_CDA_Project */
...
#define CURRENT_PACKAGE_KEY "Haskell-CDA-Project-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "Haskell-CDA-Project-0.1.0.0-inplace"
